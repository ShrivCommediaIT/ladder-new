...
// ====================================== without email id register page ======================================
// "use client";
...
//     // ✅ name hi username banega internally
//     const payload = {
...
//   return (
//     <div className="flex flex-col lg:flex-row min-h-screen bg-indigo-900 relative">
//       <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-900 z-0"></div>

//       {/* Left */}
//       <motion.div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-10 relative z-10">
//         <div className="text-center max-w-xl">
//           <h2 className="text-4xl font-extrabold mb-4 text-zinc-900">
//             Welcome to Sports Solutions Pro
//           </h2>
//         </div>
//       </motion.div>

//       {/* Right Form */}
//       <motion.div className="w-full lg:w-1/2 flex items-center justify-center px-4 pb-10 relative z-10">
