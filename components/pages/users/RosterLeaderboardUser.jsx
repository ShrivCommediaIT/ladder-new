...
const PlayerCard = ({ player, rank, onRedeemClick, onEditClick, loggedInUserId }) => {
  ...
  return (
    ...
    >
      ...
      >
        <PlayerStatusToggle player={player} user={true} forceDisabled={!isCurrentUser} showTokenStatus={true} />
        ...
        <div className="flex items-stretch sm:items-center gap-1.5 sm:gap-2.5 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-1 sm:hidden">
              <div
                className={isCurrentUser ? "flex items-center gap-2 cursor-pointer" : "flex items-center gap-2"}
                onClick={(e) => {
            ...
            <div className="hidden sm:flex sm:flex-wrap sm:items-center sm:gap-x-3 sm:gap-y-1.5">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className="text-sm font-bold px-2 py-0.5 rounded best-board-tag-soft"
                >
                  {player?.today_token ?? "0"}
                </span>
              </div>
