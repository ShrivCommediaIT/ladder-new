...
//   // Get ladderId from URL search params
//   const searchParams = useSearchParams();
//   const ladderId = searchParams.get("ladder_id");

//   // ✅ 1️⃣ Player slice se type (Best5 case)
//   const playerLadderType = useSelector(
//     (state) => state.player?.players?.[ladderId]?.ladderDetails?.type
//   );

//   // ✅ 2️⃣ Minileague slice se type (Minileague case)
//   const miniLeagueLadderType = useSelector(
//     (state) => state.minileague?.ladderDetails?.type
//   );

//   // ✅ 3️⃣ FINAL MERGED TYPE (automatic detection)
//   const ladderType = playerLadderType || miniLeagueLadderType;


//   const ladderTypeLabel =
//     ladderType === "best3"
//       ? "Best of 3"
//       : ladderType === "best5" || ladderType === "bestof5" || ladderType === "minileague"
//       ? "Best of 5"
//       : "Win/Lose";
...
//                     <p>🏆 <b>8 Points for a 3-0 win</b></p>
//                     <p>🏆 <b>7 Points for a 3-1 win</b></p>
//                     <p>🏆 <b>6 Points for a 3-2 win</b></p>
//                     <p>❌ <b>4 Points for a 3-2 loss</b></p>
//                     <p>❌ <b>3 Points for a 3-1 loss</b></p>
//                     <p>❌ <b>2 Points for a 3-0 loss</b></p>
//                   </div>
...
//                   <TableCell className="font-semibold text-gray-400">{data.result?.total_win}</TableCell>
//                   <TableCell className="font-semibold text-gray-400">{data.result?.win_percentage}</TableCell>
//                   <TableCell className="font-semibold text-gray-400">{data.result?.total_point}</TableCell>
...
//                       : 0}
//                   </TableCell>
//                   <TableCell className="font-semibold text-yellow-300">{data.win_rank}</TableCell>
//                 </motion.tr>
//               </TableBody>
//             </Table>
//           </motion.div>
...
import gsap from "gsap";
import { Button } from "@/components/ui/button";
import { Info, LineChart, SeparatorVertical } from "lucide-react";
import {
  Dialog,
  DialogHeader,
  DialogTitle,
