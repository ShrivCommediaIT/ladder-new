...
//                             side="right"
//                             sideOffset={10}
//                             className="max-w-md border border-white/10 bg-[#0b1020]/95 text-white backdrop-blur-xl shadow-xl"
//                           >
//                             <p className="text-sm leading-relaxed">

// {ladderDescriptions[
// Object.keys(ladderDescriptions).find(key =>
// ladder.name.toLowerCase().includes(key)
// )
// ]}
