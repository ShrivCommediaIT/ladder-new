...
//             }}
//             disabled={resetLoading}
//             className="bg-[#163344] bg-[length:200%_100%] animate-gradient-x border border-gray-400 text-white font-bold rounded-xl py-8 w-full col-span-1 sm:col-span-2 shadow-lg"
//           >
