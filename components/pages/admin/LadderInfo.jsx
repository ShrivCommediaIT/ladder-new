...
//             className="group flex items-center justify-between rounded-xl border border-white/10 bg-black/30 px-3 py-3 hover:bg-white/10 hover:shadow-lg hover:shadow-cyan-500/10 transition"
//           >
