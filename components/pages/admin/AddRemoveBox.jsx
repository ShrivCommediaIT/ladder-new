...
//   const isSkillLadder = ladderType === "skill";
//   const showMove = !isSkillLadder;
...
//           <AnimatePresence>
//             {addOpen && (
//               <DialogContent className="sm:max-w-md rounded-2xl shadow-2xl bg-[#0B1922] border border-[#1a1f2b]">
//                 <motion.div
//                   initial="hidden"
//                   animate="visible"
//                   exit="exit"
...
//                 className="bg-gradient-to-r from-[#b78b2c] to-[#66f44d] shadow-md rounded-full text-sm font-semibold text-white px-4 py-2 focus:ring-2 focus:ring-yellow-400 transition-all"
//               >
//                 Select
//               </motion.button>
//             </DialogTrigger>
