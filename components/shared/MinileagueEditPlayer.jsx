...
//   const minileagueData = useSelector(
//     (state) => state.minileague?.data || []
//   );

//   const userLadderId = useSelector(
//     (state) => state.user?.user?.ladder_id
//   );

//   const findPlayerWithSection = useCallback(() => {
//     if (!playerId || ladderType !== "minileague") return null;

//     // 1) Try given sectionIndex
//     if (
...
//           Number(p.user_id) === Number(playerId)
//       );
//       if (directPlayer) {
//         return {
//           ...directPlayer,
...
//   const playerSectionIndex =
//     selectedPlayer?.sectionIndex ?? sectionIndex ?? 0;
...
//         <DialogTitle className="p-4 border-b border-gray-700 text-violet-400">
//           {selectedPlayer?.name}
//         </DialogTitle>
