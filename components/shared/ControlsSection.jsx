...
export default function ControlsSection({
  ...
  return (
    <>
      ...
      <div className={`${mobileSection === "toolbar" || mobileSection === "players" ? "block" : "hidden"} lg:sticky lg:top-[4.8rem] lg:block`}>
        <div className="z-20 mb-4 flex flex-col gap-4 bg-[var(--best-board-bg)] pb-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap gap-2">
            ...
            <Dialog open={addRemoveOpen} onOpenChange={setAddRemoveOpen}>
              <DialogTrigger asChild>
                <ActionButton icon={Plus}>Add / Remove</ActionButton>
              </DialogTrigger>
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-[var(--best-board-muted)]">Sections</span>
            <select
              value={groupSize}
