...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className={user?.user_type === "sub_admin" ? "max-w-2xl mx-auto w-full" : "grid grid-cols-1 lg:grid-cols-12 gap-8"}>
          ...
          <div className={user?.user_type === "sub_admin" ? "w-full" : "lg:col-span-5 flex flex-col gap-6"}>
            <div className="bg-white dark:bg-zinc-900/60 backdrop-blur-xl border border-slate-100 dark:border-zinc-800/80 shadow-xl rounded-2xl p-6 sm:p-8 transition-all duration-300">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="relative">
                  {/* Avatar container */}
                  <div className="relative group w-32 h-32 rounded-full overflow-hidden border-4 border-slate-100 dark:border-zinc-800/60 bg-slate-100 dark:bg-zinc-800 shadow-md transition-all duration-300 hover:scale-[1.02] flex items-center justify-center">
                ...
                <h3 className="mt-4 text-lg font-bold text-slate-800 dark:text-zinc-100 leading-tight">
                  {name || "User Profile"}
                </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
                    Email / ID
                  </Label>
                  <div className="relative">
                ...
                {/* Name */}
                <div>
                  <Label htmlFor="profile-name" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
                    Full Name
                  </Label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-slate-400 dark:text-zinc-500" />
                    <Input
                      id="profile-name"
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                      placeholder="Enter Full Name"
                      className="h-11 pl-10 rounded-xl w-full bg-slate-50 dark:bg-zinc-800/20 border border-slate-200 dark:border-zinc-700/60 text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                    />
                  </div>
                </div>
                ...
                {/* Phone */}
                <div>
                  <Label htmlFor="profile-phone" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
                    Phone Number (Optional)
                  </Label>
                  <div className="relative">
                    <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-slate-400 dark:text-zinc-500" />
                    <Input
                      id="profile-phone"
                      value={phone}
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="bg-white dark:bg-zinc-900/60 backdrop-blur-xl border border-slate-100 dark:border-zinc-800/80 shadow-xl rounded-2xl p-6 sm:p-8 transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  {/* Old Password */}
                  <div>
                    <Label htmlFor="old-password" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
                      Current Password
                    </Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-slate-400 dark:text-zinc-500" />
                      <Input
                        id="old-password"
                        ...
                        className="h-11 pl-10 pr-10 rounded-xl w-full bg-slate-50 dark:bg-zinc-800/20 border border-slate-200 dark:border-zinc-700/60 text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                      />
                      <button
                        type="button"
                  ...
                  {/* New Password */}
                  <div>
                    <Label htmlFor="new-password" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
                      New Password
                    </Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-slate-400 dark:text-zinc-500" />
                    ...
                    {newPassword && (() => {
                      ...
                      return (
                        <div className="mt-2.5 p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/30 border border-slate-200/50 dark:border-zinc-800/60 transition-all duration-300">
                          ...
                          <div className="h-1.5 w-full bg-slate-200 dark:bg-zinc-800 rounded-full overflow-hidden flex gap-1">
                            <div className={`h-full flex-1 rounded-full transition-all duration-300 ${strength.score >= 1 ? strength.bgColor : "bg-slate-200 dark:bg-zinc-800"}`} />
                            <div className={`h-full flex-1 rounded-full transition-all duration-300 ${strength.score >= 2 ? strength.bgColor : "bg-slate-200 dark:bg-zinc-800"}`} />
                            <div className={`h-full flex-1 rounded-full transition-all duration-300 ${strength.score >= 3 ? strength.bgColor : "bg-slate-200 dark:bg-zinc-800"}`} />
                          </div>
                  ...
                  {/* Confirm Password */}
                  <div>
                    <Label htmlFor="confirm-password" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-1.5 block">
      ...
      >
        <DialogContent className="max-w-md p-6 rounded-2xl border shadow-2xl backdrop-blur-md bg-white dark:bg-zinc-900 text-slate-900 dark:text-white border-slate-100 dark:border-zinc-800">
          <DialogHeader>
          ...
          {confirmModal.type === "image" && previewUrl && (
            <div className="flex flex-col items-center my-4 p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/40 border border-slate-200/50 dark:border-zinc-800">
              <span className="text-xs text-slate-400 dark:text-zinc-500 mb-2 font-semibold uppercase tracking-wider">New Avatar Preview</span>
              <img
                src={previewUrl}
          ...
          <DialogFooter className="mt-6 flex gap-3 sm:justify-end">
            <Button
              ...
              className="px-5 h-10.5 rounded-xl border border-slate-200 hover:bg-slate-50 dark:border-zinc-800 dark:hover:bg-zinc-800 transition-colors text-xs font-semibold text-slate-600 dark:text-zinc-300"
            >
              Cancel
            </Button>
            <Button
